<template>
    <div>
      ...
      <button type="button" class="btn btn-primary" @click="goToEditFilm(filmId)">Edit</button>
      <button type="submit" @click="confirmDelete" class="btn btn-danger">Delete</button>
  </template>
    ...
    methods: {
      ...
      async deleteFilm() {
        try {
          ...
          alert('An error might have happen please try later');
        }
      },
      goToEditFilm(filmId) {
